...
import { FaArrowLeft, FaUser, FaProjectDiagram, FaImage, FaPalette, FaSave, FaEye } from "react-icons/fa"
...
const PortfolioCreator = () => {
  ...
  const steps = [
    ...
    { title: "Media", icon: FaImage },
    { title: "Theme", icon: FaPalette },
  ]
  ...
  const renderProfileForm = () => (
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="clay-card p-4">
      ...
      <Row>
        ...
        <Col md={6} className="mb-3">
          <Form.Group>
            <Form.Label className="text-white">Professional Title</Form.Label>
            <Form.Control
              type="text"
      ...
      case 1:
        return (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="clay-card p-4">
            ...
            <p className="text-white opacity-75">Add your projects here...</p>
          </motion.div>
        )
      case 2:
        return (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="clay-card p-4">
            <h4 className="text-white font-bold mb-4">Media & Assets</h4>
            <p className="text-white opacity-75">Upload images and media here...</p>
          </motion.div>
        )
      case 3:
        return (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="clay-card p-4">
            <h4 className="text-white font-bold mb-4">Theme Selection</h4>
            <p className="text-white opacity-75">Choose your portfolio theme...</p>
          </motion.div>
        )
      default:
        return null
        ...
        <Container>
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              ...
              <h4 className="text-white mb-0">Portfolio Creator</h4>
            </div>
            ...
            >
              ...
              <div className="bg-white rounded-3 p-4 min-h-96">
                <div className="text-center">
                  ...
                  ></div>
                  <h6 className="mb-1">{portfolioData.profile.name || "Your Name"}</h6>
                  <p className="text-muted small mb-3">{portfolioData.profile.title || "Your Title"}</p>
                  <p className="small text-muted">{portfolioData.profile.bio || "Your bio will appear here..."}</p>
                </div>
              </div>
            </motion.div>
          </Col>
